...
#### 2025年9月18日 (最新)
- ✨ **前回記載機能追加**: 「前回の記載」入力フィールドをメイン画面に追加
- 🔄 **認証統一**: GEMINI_CREDENTIALS → GOOGLE_CREDENTIALS_JSON への完全移行
- 📋 **プロンプト改善**: AIプロンプトに前回記載情報を統合
- 🎨 **UI最適化**: テキストエリアの高さを70pxに調整
- 📖 **ドキュメント更新**: README.mdの全面改訂 (新機能・認証情報の反映)

#### 2025年9月16日
- 🧪 **テストコード全面修正**: OpenAI関連コードの削除に伴うテスト修正完了
- ✅ **テストスイート正常化**: 120個すべてのテストが正常に通過
- 🔧 **設定テスト更新**: AWS/Anthropic設定への移行対応
- 🌐 **エラーメッセージ改善**: 文字化け修正と英語化
...
- [x] チェンジログ・進捗ドキュメント整備
- [x] OpenAI関連コード削除によるテストコード修正
- [x] 全テストスイートの正常化 (120/120 通過)
- [x] **前回記載機能の実装完了** (NEW)
- [x] **GOOGLE_CREDENTIALS_JSON への認証統一** (NEW)
- [x] **README.md ドキュメント全面改訂** (NEW)
- [ ] パフォーマンス最適化検討
